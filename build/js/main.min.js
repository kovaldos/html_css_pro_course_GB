...
var _initProductPageSlider = require("./modules/galleries/init-product-page-slider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _initProductPageSlider.initProductPageSlider)();
...
},{"./modules/accordions/init-accordion":3,"./modules/form-validate/form":5,"./modules/galleries/init-product-page-slider":11,"./modules/input-file/init-upload":16,"./modules/modals/init-modals":19,"./modules/select/custom-select":22,"./utils/ios-vh-fix":25}],2:[function(require,module,exports){
"use strict";
...
exports.initProductPageSlider = void 0;
/* eslint-disable no-undef */

var initProductPageSlider = function initProductPageSlider() {
  var productHeroSliderText = document.querySelector('.product-hero__slider-text');
  ...
  var productHeroSlider = document.querySelector('.product-hero__slider');
...
exports.initProductPageSlider = initProductPageSlider;
