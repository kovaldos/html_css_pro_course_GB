...
},{"./modules/form-validate/form":3,"./modules/galleries/init-product-page-slider":9,"./modules/input-file/init-upload":14,"./modules/modals/init-modals":17,"./modules/select/custom-select":20,"./utils/ios-vh-fix":23}],2:[function(require,module,exports){
"use strict";
...
var initProductPageSlider = function initProductPageSlider() {
  var productPageSlider = document.querySelector('.product-hero__slider');
